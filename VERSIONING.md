...
LDFLAGS="-s -w -X main.Version=1.2.0 -X main.Commit=$COMMIT -X main.BuildTime=$BUILD_TIME"
```
...
```go
var (
    Version   = "dev"         // Injected: -X main.Version=1.2.0
...
4. Push changes and tags: `git push origin master v1.2.0`
